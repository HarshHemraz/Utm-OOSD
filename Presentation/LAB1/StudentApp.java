...
public class StudentApp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Student Information", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 3, 24), new java.awt.Color(102, 153, 255))); // NOI18N
        ...
        jLabel4.setText("Enter student number:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String s1 = jTextField1.getText();//id
        String s2 = jTextField2.getText();//name
        String s3 = jTextField3.getText();//address
        String s4 = jTextField4.getText();//number
        
        int studentID = Integer.parseInt(s1);
        int studentNumber = Integer.parseInt(s4);
        
        Student newStudent = new Student();
        
        newStudent.setStudentId(studentID);
        newStudent.setStudentName(s2);
        newStudent.setStudentAddress(s3);
        ...
        JOptionPane.showMessageDialog(null, "New Student has been added \nStudent ID: " + newStudent.getStudentId() +
                "\nStudent name: " + newStudent.getStudentName() + "\nStudent Address: " + newStudent.getStudentAddress() +
                "\nStudent number: " + newStudent.getStudentNumber());
