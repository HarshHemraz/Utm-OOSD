...
public class BookApp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Book App", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 3, 24), new java.awt.Color(0, 102, 255))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        s1 = jTextField1.getText(); //title
        s2 = jTextField2.getText(); 
        s3 = jTextField3.getText(); 
        s4 = jTextField4.getText(); //Author
        s5 = jTextField5.getText(); 
        
        int s6 = Integer.parseInt(s2);//ISBN
        double s7 = Double.parseDouble(s3);//PRice
        int s8 = Integer.parseInt(s5);//pages
        
        Book newBook = new Book();
        
        newBook.setBookTitle(s1);
        newBook.setBookISBN(s6);
        newBook.setBookPrice(s7);
        newBook.setBookAuthor(s4);
        newBook.setNumberOfPages(s8);
        
        String output = "New book added Successfully: \n-----------------------\nBook title: " + newBook.getBookTitle()+
                        "\nBook ISBN: " + newBook.getBookISBN() + "\nBook Price: " + newBook.getBookPrice() + "\nBook Author: " 
                        + newBook.getBookAuthor() + "\nNumber of pages: " + newBook.getNumberOfPages();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Book newBook = new Book(s1,s6,s7,s4,s8);
        
          String output = "Create book Successfully with overloaded constructor: \n-----------------------\nBook title: " + newBook.getBookTitle()+
                        "\nBook ISBN: " + newBook.getBookISBN() + "\nBook Price: " + newBook.getBookPrice() + "\nBook Author: " 
                        + newBook.getBookAuthor() + "\nNumber of pages: " + newBook.getNumberOfPages();
