...
public class Student_Info extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Student Information", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 24), new java.awt.Color(51, 153, 255))); // NOI18N
        ...
        jLabel4.setText("Enter student contact number:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String info3 = jTextField3.getText();
        String info4 = jTextField4.getText();
        int id = 0;
        ...
        int contactNo = Integer.parseInt(info4);
        
        newStudent.setStudentID(id);
        newStudent.setStudentName(info2);
        newStudent.setStudentAddress(info3);
        newStudent.setContantNum(contactNo);
        
       int outputId = newStudent.getStudentId();
       String outputName = newStudent.getStudentName();
       String outputAddress = newStudent.getStudentAddress();
       int outputContactNo = newStudent.getContactNumber();
       
       JOptionPane.showMessageDialog(null, "Student id: " + outputId + "\nStudent name: " + outputName + "\nStudent Address: " + outputAddress + "\nContact No: " + outputContactNo );  
